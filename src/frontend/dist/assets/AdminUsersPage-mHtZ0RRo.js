import { r as reactExports, x as ue, j as jsxRuntimeExports, m as motion, B as Button, t as Badge, as as Users, U as User, ag as Search, P as Package, ah as Skeleton, V as Mail, W as Phone, a1 as Calendar, G as ShoppingBag, M as MapPin, X } from "./index-BSySFNaW.js";
import { A as AdminLayout, S as Send } from "./AdminLayout-2gYHCLuq.js";
...
import { F as subscribeToUsers, G as updateUser, H as sendPromoEmail, I as getUserOrders } from "./adminService-C_DVe4vg.js";
...
function formatDate(val) {
  if (!val) return "—";
  const dateValue = typeof val === "object" && val && "toDate" in val ? val.toDate() : val instanceof Date ? val : new Date(val);
...
function AdminUsersPage() {
  ...
  const [promoSending, setPromoSending] = reactExports.useState(false);
  ...
  async function handleSendPromo() {
    ...
    try {
      const result = await sendPromoEmail({
        ...
        activityDays: promoForm.audience === "active" || promoForm.audience === "inactive" ? Number(promoForm.activityDays) || 60 : void 0,
      ...
      ue.error("Failed to send promo email");
    } finally {
    ...
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl overflow-hidden glass-card border border-border/50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:grid grid-cols-[2.2fr_1fr_0.8fr_0.9fr_1fr_0.8fr_0.8fr] items-center gap-3 px-4 py-3 border-b border-border/40 bg-muted/30", children: ["User", "Phone", "Orders", "Spent", "Joined", "Status", ""].map(
          ...
          loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: SKELETON_KEYS.map((key) => /* @__PURE__ */ jsxRuntimeExports.jsx(SkeletonRow, {}, key)) }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center justify-center gap-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: formatCurrency(user.totalSpent) }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: formatDate(user.createdAt) }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: promoOpen, onOpenChange: setPromoOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-xl glass-card border-border/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-lg font-semibold", children: "Send Promo Email" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { "data-ocid": "promo-audience-select", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "All users" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "New = no orders. Inactive/Active use last order date." })
            ] }),
            (promoForm.audience === "inactive" || promoForm.audience === "active") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "promo-days", children: "Activity window (days)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  id: "promo-days",
                  ...
                  onChange: (e) => handlePromoChange("activityDays", e.target.value),
                  placeholder: "60",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "promo-coupon", children: "Coupon code" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  id: "promo-coupon",
                  value: promoForm.couponCode,
                  onChange: (e) => handlePromoChange("couponCode", e.target.value.toUpperCase()),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "promo-subject", children: "Subject" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  id: "promo-subject",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "promo-message", children: "Message" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Textarea,
                {
                  id: "promo-message",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setPromoOpen(false), children: "Cancel" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: promoSending ? "Sending…" : "Send Email"
                }
              )
            ] })
          ] })
