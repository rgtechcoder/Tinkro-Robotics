import { h as createLucideIcon, r as reactExports, j as jsxRuntimeExports, m as motion, w as ShoppingBag, ak as Users, H as Mail, A as AnimatePresence, o as ue } from "./index-O-oxzsBJ.js";
import { A as AdminLayout, D as Download } from "./AdminLayout-DnmFTD6u.js";
...
function exportToExcel(data, columns, filename) {
  ...
  writeFileSync(workbook, safeFilename);
}
function formatTs(d) {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "linear-gradient(135deg, oklch(0.71 0.17 48 / 0.22), oklch(0.76 0.16 72 / 0.14))",
                border: "1px solid oklch(0.71 0.17 48 / 0.35)"
              },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.88 0.14 55)" }, children: icon })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-bold text-white", children: title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
...
function StyledInput({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "input",
    {
      ...
      onFocus: (e) => {
        e.target.style.borderColor = "oklch(0.71 0.17 48 / 0.5)";
      },
      onBlur: (e) => {
        e.target.style.borderColor = "oklch(0.22 0.05 243 / 0.45)";
      }
    }
  );
}
...
function ExportButton({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      style: {
        background: loading ? "oklch(0.35 0.08 48)" : "linear-gradient(135deg, oklch(0.71 0.17 48), oklch(0.76 0.16 72))",
        boxShadow: loading ? "none" : "0 0 16px oklch(0.71 0.17 48 / 0.35)"
      },
      children: [
        loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { size: 15 }),
...
function OrdersExportCard({
  ...
  const [dateRange, setDateRange] = reactExports.useState({ from: "", to: "" });
  const [statusFilter, setStatusFilter] = reactExports.useState("all");
  const [loading, setLoading] = reactExports.useState(false);
  const [counting, setCounting] = reactExports.useState(false);
  ...
  async function handleExport() {
    ...
    try {
      ...
      onExported(entry);
      ue.success(
        rows.length === 0 ? "No orders to export (Firebase offline)" : `Exported ${rows.length} records to ${filename}.xlsx`
      );
    } catch (err) {
      console.error(err);
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FilterLabel, { children: "From Date" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                StyledInput,
                {
                  id: "orders-from",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FilterLabel, { children: "To Date" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                StyledInput,
                {
                  id: "orders-to",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FilterLabel, { children: "Status" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              StyledSelect,
              {
                value: statusFilter,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(RecordCountBadge, { count, loading: counting }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px]", style: { color: "oklch(0.40 0.04 243)" }, children: ".xlsx format" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ExportButton,
          {
...
function UsersExportCard({
  ...
  async function handleExport() {
    ...
    try {
      ...
      onExported(entry);
      ue.success("No users to export (Firebase offline)");
    } catch (err) {
      console.error(err);
      ue.error("Export failed. Please try again.");
    } finally {
    ...
    CardShell,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FilterLabel, { children: "Joined From" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                StyledInput,
                {
                  id: "users-from",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FilterLabel, { children: "Joined To" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                StyledInput,
                {
                  id: "users-to",
...
function EnquiriesExportCard({
  ...
  async function handleExport() {
    ...
    try {
      ...
      onExported(entry);
      ue.success("No enquiries to export (Firebase offline)");
    } catch (err) {
      console.error(err);
      ue.error("Export failed. Please try again.");
    } finally {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FilterLabel, { children: "Lab Type" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                StyledSelect,
                {
                  value: labTypeFilter,
...
const TYPE_ICON = {
  orders: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { size: 13 }),
  users: /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 13 }),
  enquiries: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 13 })
};
const TYPE_COLOR = {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold text-white", children: "Export History" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  className: "text-[11px]",
                  style: { color: "oklch(0.45 0.04 243)" },
                  children: "This session only"
                }
              )
            ] })
          ] }),
        ...
        history.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "oklch(0.40 0.04 243)" }, children: "No exports yet this session" })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", "data-ocid": "export-history-list", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: history.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: TYPE_COLOR[entry.type] }, children: TYPE_ICON[entry.type] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-white/80 truncate", children: entry.filename }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    className: "text-[10px]",
...
function AdminExportPage() {
  ...
  function handleExported(entry) {
    setExportHistory((prev) => [entry, ...prev]);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "admin-export-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-bold text-white", children: "Export Data" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm", style: { color: "oklch(0.50 0.05 243)" }, children: "Download your business data as Excel files" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(OrdersExportCard, { onExported: handleExported })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          animate: { opacity: 1, y: 0 },
          transition: { duration: 0.35, delay: 0.1 },
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(UsersExportCard, { onExported: handleExported })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(EnquiriesExportCard, { onExported: handleExported })
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
