import { k as createLucideIcon, a5 as commonjsGlobal, a6 as getDefaultExportFromCjs, r as reactExports, a7 as clsx, a8 as React, a9 as invariant, j as jsxRuntimeExports, m as motion, S as ShoppingCart, P as Package, T as Tag, a2 as Clock, J as ArrowRight } from "./index-BSySFNaW.js";
import { A as AdminLayout } from "./AdminLayout-2gYHCLuq.js";
import { a as subscribeToAllOrders, b as subscribeToProducts, c as subscribeToCategories } from "./adminService-C_DVe4vg.js";
import { T as TrendingUp } from "./trending-up-ByBCjKRr.js";
...
function formatLabel(dateKey) {
  const d2 = /* @__PURE__ */ new Date(`${dateKey}T00:00:00`);
  return d2.toLocaleDateString("en-IN", { month: "short", day: "numeric" });
}
...
function SkeletonCard() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-slate-700/40 bg-slate-900/60 p-6 animate-pulse", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-4 w-24 rounded bg-slate-700/60" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-10 w-10 rounded-xl bg-slate-700/60" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-32 rounded bg-slate-700/60 mb-2" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-3 w-20 rounded bg-slate-700/40" })
  ] });
}
function SkeletonRow() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: [1, 2, 3, 4, 5].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-4 rounded bg-slate-700/40 animate-pulse" }) }, i)) });
}
    ...
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-slate-400", children: label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-display font-bold text-white tracking-tight", children: value }),
...
function ChartTooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-slate-600/50 bg-slate-800/90 backdrop-blur-sm px-3 py-2 shadow-lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-400 mb-1", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-white", children: isCurrency ? formatCurrency(payload[0].value) : payload[0].value.toString() })
  ] });
}
function AdminDashboardPage() {
  ...
  const [loadingOrders, setLoadingOrders] = reactExports.useState(true);
  const [loadingProducts, setLoadingProducts] = reactExports.useState(true);
  ...
  const chartData = reactExports.useMemo(() => {
    ...
    for (const d2 of days) {
      revenueMap[d2] = 0;
      ordersMap[d2] = 0;
      usersByDay[d2] = /* @__PURE__ */ new Set();
    }
    for (const o of orders) {
      const key = formatDateKey(o.createdAt);
      if (revenueMap[key] !== void 0) {
  ...
  const recentOrders = reactExports.useMemo(() => {
    return [...orders].sort((a2, b2) => {
      const ta = typeof a2.createdAt === "string" ? new Date(a2.createdAt).getTime() : a2.createdAt.toMillis();
      const tb = typeof b2.createdAt === "string" ? new Date(b2.createdAt).getTime() : b2.createdAt.toMillis();
      return tb - ta;
    }).slice(0, 5);
  }, [orders]);
  const isLoading = loadingOrders || loadingProducts || loadingCategories;
  const tickFormatter = (val, idx) => idx % 5 === 0 ? val : "";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", "data-ocid": "admin-dashboard-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-bold text-white", children: "Dashboard Overview" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-slate-400", children: "Welcome back — here's what's happening with Tinkro today" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SummaryCard,
        {
          ...
          sub: orders.length === 0 ? "No orders yet" : `${recentOrders.length} recent`,
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { className: "h-5 w-5 text-white" }),
          gradient: "bg-[#F47B20]",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SummaryCard,
        {
          ...
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(IndianRupee, { className: "h-5 w-5 text-white" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SummaryCard,
        {
          ...
          sub: products.length === 0 ? "Add your first product" : "In catalog",
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "h-5 w-5 text-white" }),
          gradient: "bg-[#3BBFBF]",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SummaryCard,
        {
          ...
          sub: categories.length === 0 ? "Add your first category" : "Active categories",
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { className: "h-5 w-5 text-white" }),
          gradient: "bg-[#2E6DA4]",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-3 gap-6", children: [
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-4 w-4 text-[#F47B20]" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-white", children: "Revenue Trends" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-xs text-slate-500", children: "Last 30 days" })
            ] }),
            loadingOrders ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[280px] rounded-xl bg-slate-700/30 animate-pulse" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 280, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AreaChart, { data: chartData, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "linearGradient",
                {
                  ...
                  y2: "1",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "5%", stopColor: "#F47B20", stopOpacity: 0.3 }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "95%", stopColor: "#F47B20", stopOpacity: 0 })
                  ]
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Tooltip,
                {
                  content: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartTooltip, { isCurrency: true }),
                  cursor: {
                    stroke: "#F47B20",
                    strokeWidth: 1,
                    strokeOpacity: 0.4
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { className: "h-4 w-4 text-[#3BBFBF]" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-white", children: "Orders Overview" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-xs text-slate-500", children: "Last 30 days" })
            ] }),
            loadingOrders ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[280px] rounded-xl bg-slate-700/30 animate-pulse" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 280, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: chartData, barSize: 6, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                CartesianGrid,
                {
                  strokeDasharray: "3 3",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-4 w-4 text-[#2E6DA4]" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-white", children: "User Growth" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-xs text-slate-500", children: "Cumulative" })
            ] }),
            loadingOrders ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[280px] rounded-xl bg-slate-700/30 animate-pulse" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 280, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: chartData, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                CartesianGrid,
                {
                  strokeDasharray: "3 3",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 py-4 border-b border-slate-700/40", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-4 w-4 text-slate-400" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-white", children: "Recent Orders" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
          ...
          loadingOrders ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("table", { className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-slate-800/60 border border-slate-700/40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { className: "h-8 w-8 text-slate-500" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-semibold text-white mb-2", children: "No orders yet" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-500 max-w-xs", children: "Orders will appear here once customers start buying from the store." })
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "text-slate-500 text-xs uppercase tracking-wider", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-3 text-left font-medium", children: "Order ID" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-3 text-left font-medium", children: "Customer" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-3 text-right font-medium", children: "Total" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-3 text-left font-medium", children: "Status" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-3 text-left font-medium", children: "Date" })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-slate-700/30", children: recentOrders.map((order, i) => {
              var _a;
              const status = order.status;
              const { bg, text } = getStatusColor(status);
              const dateStr = typeof order.createdAt === "string" ? new Date(order.createdAt).toLocaleDateString(
                "en-IN",
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.tr,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-6 py-4 font-mono text-xs text-slate-300", children: [
                      "#",
                      order.id.slice(0, 8).toUpperCase()
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 text-slate-300 truncate max-w-[120px]", children: order.customerEmail ? order.customerEmail.split("@")[0] : ((_a = order.userId) == null ? void 0 : _a.slice(0, 10)) ?? "—" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 text-right font-semibold text-white tabular-nums", children: formatCurrency(order.total) }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 text-slate-400 text-xs whitespace-nowrap", children: dateStr })
                  ]
                },
                order.id
              );
